...
type Callback struct {
	Path                   []*NamedPathItem `thrift:"path,1,default,list<NamedPathItem>" form:"path" json:"path" query:"path"`
	SpecificationExtension []*NamedAny      `thrift:"specification_extension,2,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type CallbacksOrReferences struct {
	AdditionalProperties []*NamedCallbackOrReference `thrift:"additional_properties,1,default,list<NamedCallbackOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type Components struct {
	...
	SpecificationExtension []*NamedAny                  `thrift:"specification_extension,10,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type Contact struct {
	...
	SpecificationExtension []*NamedAny `thrift:"specification_extension,4,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type Discriminator struct {
	...
	SpecificationExtension []*NamedAny `thrift:"specification_extension,3,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type Document struct {
	...
	Servers                []*Server              `thrift:"servers,3,default,list<Server>" form:"servers" json:"servers" query:"servers"`
	...
	Security               []*SecurityRequirement `thrift:"security,6,default,list<SecurityRequirement>" form:"security" json:"security" query:"security"`
	Tags                   []*Tag                 `thrift:"tags,7,default,list<Tag>" form:"tags" json:"tags" query:"tags"`
	ExternalDocs           *ExternalDocs          `thrift:"external_docs,8" form:"external_docs" json:"external_docs" query:"external_docs"`
	SpecificationExtension []*NamedAny            `thrift:"specification_extension,9,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type Encoding struct {
	...
	SpecificationExtension []*NamedAny          `thrift:"specification_extension,6,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type Encodings struct {
	AdditionalProperties []*NamedEncoding `thrift:"additional_properties,1,default,list<NamedEncoding>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type Example struct {
	...
	SpecificationExtension []*NamedAny `thrift:"specification_extension,5,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type ExamplesOrReferences struct {
	AdditionalProperties []*NamedExampleOrReference `thrift:"additional_properties,1,default,list<NamedExampleOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type Expression struct {
	AdditionalProperties []*NamedAny `thrift:"additional_properties,1,default,list<NamedAny>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type Header struct {
	...
	SpecificationExtension []*NamedAny           `thrift:"specification_extension,12,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type HeadersOrReferences struct {
	AdditionalProperties []*NamedHeaderOrReference `thrift:"additional_properties,1,default,list<NamedHeaderOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type Info struct {
	...
	SpecificationExtension []*NamedAny `thrift:"specification_extension,7,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
...
type ItemsItem struct {
	SchemaOrReference []*SchemaOrReference `thrift:"schema_or_reference,1,default,list<SchemaOrReference>" form:"schema_or_reference" json:"schema_or_reference" query:"schema_or_reference"`
}
...
type LinksOrReferences struct {
	AdditionalProperties []*NamedLinkOrReference `thrift:"additional_properties,1,default,list<NamedLinkOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type MediaTypes struct {
	AdditionalProperties []*NamedMediaType `thrift:"additional_properties,1,default,list<NamedMediaType>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type Operation struct {
	Tags                   []string                `thrift:"tags,1,default,list<string>" form:"tags" json:"tags" query:"tags"`
	...
	Parameters             []*ParameterOrReference `thrift:"parameters,6,default,list<ParameterOrReference>" form:"parameters" json:"parameters" query:"parameters"`
	...
	Security               []*SecurityRequirement  `thrift:"security,11,default,list<SecurityRequirement>" form:"security" json:"security" query:"security"`
	Servers                []*Server               `thrift:"servers,12,default,list<Server>" form:"servers" json:"servers" query:"servers"`
	SpecificationExtension []*NamedAny             `thrift:"specification_extension,13,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type Parameter struct {
	...
	SpecificationExtension []*NamedAny           `thrift:"specification_extension,14,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type ParametersOrReferences struct {
	AdditionalProperties []*NamedParameterOrReference `thrift:"additional_properties,1,default,list<NamedParameterOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type PathItem struct {
	...
	Servers                []*Server               `thrift:"servers,12,default,list<Server>" form:"servers" json:"servers" query:"servers"`
	Parameters             []*ParameterOrReference `thrift:"parameters,13,default,list<ParameterOrReference>" form:"parameters" json:"parameters" query:"parameters"`
	SpecificationExtension []*NamedAny             `thrift:"specification_extension,14,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type Properties struct {
	AdditionalProperties []*NamedSchemaOrReference `thrift:"additional_properties,1,default,list<NamedSchemaOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type RequestBodiesOrReferences struct {
	AdditionalProperties []*NamedRequestBodyOrReference `thrift:"additional_properties,1,default,list<NamedRequestBodyOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type Responses struct {
	...
	ResponseOrReference    []*NamedResponseOrReference `thrift:"response_or_reference,2,default,list<NamedResponseOrReference>" form:"response_or_reference" json:"response_or_reference" query:"response_or_reference"`
	SpecificationExtension []*NamedAny                 `thrift:"specification_extension,3,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type ResponsesOrReferences struct {
	AdditionalProperties []*NamedResponseOrReference `thrift:"additional_properties,1,default,list<NamedResponseOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type Schema struct {
	...
	Required               []string                  `thrift:"required,23,default,list<string>" form:"required" json:"required" query:"required"`
	Enum                   []*Any                    `thrift:"enum,24,default,list<Any>" form:"enum" json:"enum" query:"enum"`
	Type                   string                    `thrift:"type,25" form:"type" json:"type" query:"type"`
	AllOf                  []*SchemaOrReference      `thrift:"all_of,26,default,list<SchemaOrReference>" form:"all_of" json:"all_of" query:"all_of"`
	OneOf                  []*SchemaOrReference      `thrift:"one_of,27,default,list<SchemaOrReference>" form:"one_of" json:"one_of" query:"one_of"`
	AnyOf                  []*SchemaOrReference      `thrift:"any_of,28,default,list<SchemaOrReference>" form:"any_of" json:"any_of" query:"any_of"`
	...
	SpecificationExtension []*NamedAny               `thrift:"specification_extension,36,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type SecurityRequirement struct {
	AdditionalProperties []*NamedStringArray `thrift:"additional_properties,1,default,list<NamedStringArray>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type SecuritySchemesOrReferences struct {
	AdditionalProperties []*NamedSecuritySchemeOrReference `thrift:"additional_properties,1,default,list<NamedSecuritySchemeOrReference>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type ServerVariable struct {
	...
	Enum                   []string    `thrift:"enum,2,default,list<string>" form:"enum" json:"enum" query:"enum"`
	Description            string      `thrift:"description,3" form:"description" json:"description" query:"description"`
	SpecificationExtension []*NamedAny `thrift:"specification_extension,4,default,list<NamedAny>" form:"specification_extension" json:"specification_extension" query:"specification_extension"`
}
...
type ServerVariables struct {
	AdditionalProperties []*NamedServerVariable `thrift:"additional_properties,1,default,list<NamedServerVariable>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
...
type StringArray struct {
	Values []string `thrift:"values,1,default,list<string>" form:"values" json:"values" query:"values"`
}
...
type Strings struct {
	AdditionalProperties []*NamedString `thrift:"additional_properties,1,default,list<NamedString>" form:"additional_properties" json:"additional_properties" query:"additional_properties"`
}
